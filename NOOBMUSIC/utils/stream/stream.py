...
import config
from NOOBMUSIC import Carbon, YouTube, app
from NOOBMUSIC.core.call import Iro
from NOOBMUSIC.misc import db
from NOOBMUSIC.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from NOOBMUSIC.utils.exceptions import AssistantErr
from NOOBMUSIC.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from NOOBMUSIC.utils.inline.playlist import close_markup
from NOOBMUSIC.utils.pastebin import Irobin
from NOOBMUSIC.utils.stream.queue import put_queue, put_queue_index
from NOOBMUSIC.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Iro.force_stop_stream(chat_id)
