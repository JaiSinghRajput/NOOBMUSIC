...
from NOOBMUSIC import Telegram, YouTube, app
from NOOBMUSIC.misc import SUDOERS, _boot_
from NOOBMUSIC.plugins.playlist import del_plist_msg
from NOOBMUSIC.plugins.sudoers import sudoers_list
from NOOBMUSIC.utils.database import (add_served_chat,
                                       add_served_user,
                                       get_served_chats,
                                       get_served_users,
                                       blacklisted_chats,
...
from NOOBMUSIC.utils.decorators.language import LanguageStart
from NOOBMUSIC.utils.formatters import get_readable_time
from NOOBMUSIC.utils.inline import (help_pannel, private_panel,
                                     start_pannel)
            ...
            key = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="• O̳̿͟͞F̳̿͟͞F̳̿͟͞I̳̿͟͞C̳̿͟͞E̳̿͟͞ •", url="https://t.me/Indian_Chating_Club"
                        ),
                    ],
                ]
            )
