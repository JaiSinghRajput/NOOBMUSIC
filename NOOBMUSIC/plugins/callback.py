...
from NOOBMUSIC.misc import SUDOERS, db
from NOOBMUSIC.utils import bot_sys_stats
from NOOBMUSIC.utils.database import (
    get_active_chats,
    get_lang,
    is_active_chat,
    is_music_playing,
...
from NOOBMUSIC.utils.formatters import seconds_to_min
from NOOBMUSIC.utils.inline import (
    stream_markup,
    stream_markup_timer,
    telegram_markup,
