...
from NOOBMUSIC.utils.database import (add_nonadmin_chat,
...
from NOOBMUSIC.utils.database.memorydatabase import (
    get_upvote_count,
    is_skipmode,
    set_upvotes,
    skip_off,
...
from NOOBMUSIC.utils.decorators.admins import ActualAdminCB
from NOOBMUSIC.utils.decorators.language import language, languageCB
from NOOBMUSIC.utils.inline.settings import (
    audio_quality_markup, auth_users_markup,
    playmode_users_markup, setting_markup,
    video_quality_markup, vote_mode_markup)
from NOOBMUSIC.utils.inline.start import private_panel
