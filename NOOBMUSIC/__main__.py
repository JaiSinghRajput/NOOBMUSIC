...
from NOOBMUSIC import LOGGER, app, userbot
from NOOBMUSIC.core.call import Iro
from NOOBMUSIC.plugins import ALL_MODULES
from NOOBMUSIC.utils.database import get_banned_users, get_gbanned
...
async def init():
    ...
    for all_module in ALL_MODULES:
        importlib.import_module("NOOBMUSIC.plugins." + all_module)
    LOGGER("NOOBMUSIC.plugins").info(
