...
from NOOBMUSIC import YouTube, app, userbot
from NOOBMUSIC.misc import SUDOERS
from NOOBMUSIC.utils.database import (get_cmode, get_lang,
                                       get_playmode, get_playtype,
                                       is_active_chat,
                                       is_commanddelete_on,
                                       is_served_private_chat)
from NOOBMUSIC.utils.exceptions import AssistantErr
from NOOBMUSIC.utils.database.assistantdatabase import get_assistant
from NOOBMUSIC.utils.database.memorydatabase import is_maintenance
        ...
        if await is_maintenance() is False:
            if message.from_user.id not in SUDOERS:
                return await message.reply_text(
                    "» ʙᴏᴛ ɪs ᴜɴᴅᴇʀ ᴍᴀɪɴᴛᴇɴᴀɴᴄᴇ ғᴏʀ sᴏᴍᴇ ᴛɪᴍᴇ, ᴩʟᴇᴀsᴇ ᴠɪsɪᴛ [O̳̿͟͞F̳̿͟͞F̳̿͟͞I̳̿͟͞C̳̿͟͞E̳̿͟͞ ᴄʜᴀᴛ](https://t.me/THE_THIRD_EYE_NETWORK) ᴛᴏ ᴋɴᴏᴡ ᴛʜᴇ ʀᴇᴀsᴏɴ..."
                )
