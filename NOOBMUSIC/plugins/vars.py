...
from NOOBMUSIC.utils.database.memorydatabase import get_video_limit
from NOOBMUSIC.utils.formatters import convert_bytes
...
async def varsFunc(client, message):
    ...
    if not config.SUPPORT_GROUP:
        ...
        s_g = f"[O̳̿͟͞F̳̿͟͞F̳̿͟͞I̳̿͟͞C̳̿͟͞E̳̿͟͞]({config.SUPPORT_GROUP})"
