...
from NOOBMUSIC import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from NOOBMUSIC.core.call import Iro
from NOOBMUSIC.utils import seconds_to_min, time_to_seconds
from NOOBMUSIC.utils.channelplay import get_channeplayCB
from NOOBMUSIC.utils.database import is_video_allowed
from NOOBMUSIC.utils.decorators.language import languageCB
from NOOBMUSIC.utils.decorators.play import PlayWrapper
from NOOBMUSIC.utils.formatters import formats
from NOOBMUSIC.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from NOOBMUSIC.utils.inline.playlist import botplaylist_markup
from NOOBMUSIC.utils.logger import play_logs
from NOOBMUSIC.utils.stream.stream import stream
        ...
        if await YouTube.exists(url):
            ...
            try:
                ...
                await mystic.edit_text(
                    "ᴛʜᴇʀᴇ's ᴀɴ ᴇʀʀᴏʀ ɪɴ ᴛʜᴇ ʙᴏᴛ, ᴩʟᴇᴀsᴇ ʀᴇᴩᴏʀᴛ ɪᴛ ᴛᴏ O̳̿͟͞F̳̿͟͞F̳̿͟͞I̳̿͟͞C̳̿͟͞E̳̿͟͞ ᴄʜᴀᴛ ᴀs sᴏᴏɴ ᴀs ᴩᴏssɪʙʟᴇ."
                )
...
@app.on_callback_query(
    filters.regex("IroymousAdmin") & ~BANNED_USERS
)
async def Iroymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
